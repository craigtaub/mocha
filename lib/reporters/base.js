...
var print = global.console.log.bind(global.console);
/**
...
exports.list = function(failures) {
  ...
  failures.forEach(function(test, i) {
    ...
    print(fmt, i + 1, testTitle, msg, stack);
  });
};
...
Base.prototype.epilogue = function() {
  ...
  print(fmt, stats.passes || 0, milliseconds(stats.duration));

  // pending
  if (stats.pending) {
    fmt = color('pending', ' ') + color('pending', ' %d pending');

    print(fmt, stats.pending);
  }
